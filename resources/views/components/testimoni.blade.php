  ...
  <div class="mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <div class="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x">
      ...
      <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
        <div class="text-center text-gray-600">“Barangnya murah dan jelas aslinya.”</div>
        ...
        <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
          ...
          <div>
            <div class="text-center text-sm font-bold text-green-700 sm:text-left md:text-base">Udik Pulyatno</div>
            <p class="text-center text-sm text-gray-500 sm:text-left md:text-sm">Customer</p>
          </div>
        </div>
      </div>
      <!-- quote - end -->
      ...
      <!-- quote - start -->
      <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
        <div class="text-center text-gray-600">“Pelayanan memuaskan dan karyawan ramah menjelaskan apa yang kita butuhkan.”</div>
        ...
        <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
          ...
          <div>
            <div class="text-center text-sm font-bold text-green-700 sm:text-left md:text-base">Nurul R. Nitta</div>
            <p class="text-center text-sm text-gray-500 sm:text-left md:text-sm">Customer</p>
          </div>
        </div>
      </div>
      ...
      <!-- quote - start -->
      <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
        <div class="text-center text-gray-600">“Sip, pelayanannya bagus dan produknya lengkap.”</div>
        ...
        <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
          ...
          <div>
            <div class="text-center text-sm font-bold text-green-700 sm:text-left md:text-base">Rino Santoni</div>
            <p class="text-center text-sm text-gray-500 sm:text-left md:text-sm">Customer</p>
          </div>
        </div>
      </div>
