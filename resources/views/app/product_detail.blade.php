    ...
    <div class="mb-8 flex flex-wrap justify-between md:mb-16">
        ...
        @foreach ($data_page as $data)
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={{ $data['image'] != NULL ? $data['image'] : "https://dummyimage.com/420x260/ddffdd/007300&text=Image+Not+Found"}}>
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">{{ $data['product_category'] }}</h2>
                    ...
                    <div class="flex">
                    <span class="title-font font-medium text-2xl text-gray-900">Rp. {{ $data['pricing'] }}</span>
